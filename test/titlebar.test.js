...
test('running timer → ▶ live clock + name, wall-clock time since fetch added', () => {
  const timers = [
  ...
  assert.equal(title, '▶ 1:24:20 Acme research — Timekeeper');
